...
6. [15. 디스크 사이즈 변경 (OS/부팅 디스크)](15-디스크-사이즈-변경.md)
7. [14. Slurm 사용 가이드 (노드 유형 · 명령어 · 작업 제출)](14-Slurm-사용-가이드.md)

### Part 3. 심화 구성 & 엔지니어링
6. [06. cluster-init 및 커스텀 스크립트](06-cluster-init-및-커스텀-스크립트.md)
7. [07. Slurm Job Accounting 구축 (MySQL Flexible Server)](07-Job-Accounting-설정.md)
8. [08. 사용자 관리 (Built-in Users & Keypair)](08-사용자-관리.md)
9. [09. 파티션 관리 및 추가 (azure.conf)](09-파티션-관리-및-추가.md)
10. [10. GPU 모니터링 구축 (Managed Prometheus + Grafana)](10-GPU-모니터링-구축.md)
