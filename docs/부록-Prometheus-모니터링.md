...
이 문서는 **Azure CycleCloud 클러스터 전반**(스케줄러 + 계산 노드)을 **Prometheus + Grafana** 로 모니터링하는 절차를 정리합니다. GPU 지표는 [10. 모니터링](10-모니터링.md)을 함께 참고하세요.
...
관련 문서: [10. 모니터링](10-모니터링.md) · [11. 트러블슈팅 및 로그 확인](11-트러블슈팅-로그.md)
